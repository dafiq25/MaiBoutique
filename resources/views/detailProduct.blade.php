                            ...
                            <div class="card shadow-sm" style="margin-top:10px; margin-right:10px; margin-left:0px; margin-bottom:10px">
                                <div class="m-2">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <a type="button" href="/delete-product/{{$data[0]->id_product}}" class="btn btn-danger col-4">Delete Item</a>
                                    </div>
                                    @elseif(Auth::user()->role == 'member')
                                    <form action="/addToCart/{{$data[0]->id_product}}" method="post">
                                        @csrf
                                        <div class="row mb-3">
                                            <div class="col-md-6" style="padding-right:3">
                                                <label for="quantity" class="form-label"><b>Quantity :</b></label>
                                                <input class="form-control @error('quantity') is-invalid @enderror" id="quantity" name="quantity" value="1" type="number">
                                                @error('quantity')
                                            ...
                                            <div class="col-md-6" style="padding-left:0">
                                                <br>
                                                <button style="margin-top:8px" type="submit" class="btn btn-success col-12">Add To Cart</button>
                                            </div>
                                        </div>
                                        <a type="button" href="/home" class="btn btn-danger col-5">Back</a>
