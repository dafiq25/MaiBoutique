        ...
        <div class="container py-5 h-100">
            ...
            <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                ...
                <div class="card-body p-5 text-center">
                    ...
                    <h2 class="fw-bold mb-5 text-uppercase">Update Password</h2>
                    <form action="/password-update" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-outline form-white mb-4" style="text-align:left">
                            ...
                            <input type="Password" name="old_password" id="old_password" class="form-control form-control-lg @error('old_password') is-invalid @enderror" placeholder="(5-20 letters)"/>
                            @error('old_password')
                        ...
                        <div class="form-outline form-white mb-4" style="text-align:left">
                            ...
                            <input type="password" name="password" id="password" class="form-control form-control-lg @error('password') is-invalid @enderror" placeholder="(5-20 letters)"/>
                            @error('password')
                                <div class="invalid-feedback">
                                    {{$message}}
                                </div>
